	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-info-sign"></i>操作面板</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
			            ...
			            <div class="well">
			                ...
			                <div id="myTabContent" class="tab-content">
			                    <div class="tab-pane active in" id="home">
			                        <form id="tab" name="formUserInfo" method="post" >
			                            <label>用户账号（用户名）：</label>
			                            <input type="text"  class="input-xlarge" name="userId" >
			                            <label>姓名：</label>
			                            <input type="text"  class="input-xlarge" name="userName" >
			                            <label>密  码：</label>
			                            <input type="password"  class="input-xlarge" name="userPwd">
										...
										<label>年龄</label>
			                            <input type="text"  class="input-xlarge" name="userAge" value="18">
			                            
			                            <label class="control-label" for="date01">生日</label>
										<div class="controls">
											<input type="text" class="input-xlarge datepicker" name="userBirthday" id="date01" value="02/16/12">
										</div>
										<label>证件类型</label>
			                            <input type="text"  class="input-xlarge" name="CertiType">
			                            <label>证件号码</label>
			                            <input type="text"  class="input-xlarge" name="CertiNum">
			                            <label>联系电话</label>
			                            <input type="text"  class="input-xlarge" name="userPhone">
			                            <label>QQ号码</label>
			                            <input type="text" class="input-xlarge" name="userQQ">
			                            <label>Email邮件</label>
			                            <input type="text"  class="input-xlarge" name="userEmail">
			                            <label>家庭住址:</label>
			                            <textarea value="Smith" rows="3" class="input-xlarge" name="userAddrs" ></textarea>
			                            <label>注册时间</label>
			                            <input type="text" class="input-xlarge datepicker" id="date02" name="userRegtime">
			                            <br><input type="button" class="btn btn-primary" name="ubtn" id="ubtnn" value="确定添加"/>
			                        </form>
			                    </div>
			                    <div class="tab-pane fade" id="profile">
			                           <label>请输入你的新密码:</label>
			                            ...
			                            <div>
			                                <a href="#" class="btn btn-update btn-round"><i class="icon-cog"></i>提交</a>
			                            </div>
