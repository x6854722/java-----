	...
	<div class="container-fluid">
		<div class="row-fluid">
	    	...
	    	<div class="pagination">
			  <ul>
			  	<li><a href="../reserveMgr!getPagerReserves?pagenow=1&module=index">第一页</a></li>
			  	<s:if test="reservePager.noPrev == false">
			    	<li><a href="../reserveMgr!getPagerReserves?pagenow=<s:property value="reservePager.pagenow-1"/>&module=index">前一页</a></li>
			    </s:if>
			    	...
			    	<s:if test="reservePager.pageCount < 7">
					   ...
					   <s:iterator>   
					    	<s:if test="%{current-1==reservePager.pagenow}">
					    		<li class="active"><a href="../reserveMgr!getPagerReserves?pagenow=<s:property value="current-1"/>&module=index" ><s:property value="current-1"/></a></li>
					    	</s:if> 
					    	<s:else>
					    		<li><a href="../reserveMgr!getPagerReserves?pagenow=<s:property value="current-1"/>&module=index" ><s:property value="current-1"/></a></li>
					    	</s:else>
					   </s:iterator>   
					   </s:bean>
					</s:if>
			    ...
			    <s:if test="reservePager.noNext == false">
			    	<li><a href="../reserveMgr!getPagerReserves?pagenow=<s:property value="reservePager.pagenow+1"/>&module=index">后一页</a></li>
			    </s:if>
			    <li><a href="../reserveMgr!getPagerReserves?pagenow=<s:property value="reservePager.pageCount"/>&module=index">尾页</a></li>
			  </ul>
			</div>
			</s:if>
